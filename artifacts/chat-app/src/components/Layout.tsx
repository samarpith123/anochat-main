...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex flex-col relative bg-background overflow-hidden" style={{ height: "100svh" }}>
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col relative z-10 w-full max-w-7xl mx-auto overflow-hidden min-h-0">
        {children}
      </main>
    </div>
  );
